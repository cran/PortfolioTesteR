---
title: "ML Strategies with PortfolioTesteR (Advanced Getting Started)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{ML Strategies with PortfolioTesteR (Advanced Getting Started)}
...
```{r ensemble, eval=has_rf || has_xgb}
...
```{r seq_gru_per_group, eval=run_seq}
